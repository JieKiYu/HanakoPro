...
const BROWSER_START_NAVIGATION_NOTE_ZH = "浏览器已启动，但还没有打开具体页面。若任务是启动画布、页面、仪表盘、预览或 dev server，请继续找到或启动对应服务，拿到真实 URL，并调用 browser.navigate 打开。";
const BROWSER_START_NAVIGATION_NOTE_EN = "Browser is running, but no specific page has been opened yet. If the task is to launch a canvas, page, dashboard, preview, or dev server, continue by finding or starting the service, get the real URL, and call browser.navigate.";
