 ...
 *   { type: "content_block", block: { type: "file"|"goal_acceptance"|"artifact"|"screenshot"|"skill"|"plugin_card"|"cron_confirm"|"settings_confirm", ... } }  (工具结果/目标验收开始等统一内容块，含 stage_files/旧 create_artifact 兼容输出/browser screenshot/install_skill/plugin card/cron 确认/settings 确认)
